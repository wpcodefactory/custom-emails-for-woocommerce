...
Our plugin allows you to add more emails than the defaults one by WooCommerce.
...
### 🚀 **Send email based on custom triggers** ###
Set any custom trigger you want to notify your customers when it happens and our plugin will allow you to send custom emails to your customers based on these custom triggers.
...
### 🚀 **Set subject, heading and content** ###
Set the subject, the heading, and the content of your custom email so you send the right message to the right people, you can use placeholders and short codes here for more personalization and customization of your email.

### 🚀 **Attach files to the custom emails** ###
If you want to send any kind of files through your custom emails our plugin allows you to attach files to your emails which gives you more control over your custom email.

### 🚀 **Set email type** ###
Send your emails in TXT, HTML, or Multipart format or Wrap your emails in WooCommerce email template if you like.

### 🚀 **Send emails manually or in bulk** ###
...
> “Woocommerce Subscription cancellation notification: This great simple to use plugin allowed me to add a free Subscription cancellation notification” – ⭐⭐⭐⭐⭐ [2u2a](https://wordpress.org/support/topic/woocommerce-subscription-cancellation-notification/)
...
> “This plugin is exactly what I needed, and Tom (and the wider team) at WPFactory go above and beyond to help if you need support. I have no hesitation in recommending this plugin to anyone looking to send well designed custom emails from WooCommerce.” – ⭐⭐⭐⭐⭐ [Shannon Novak](https://wpfactory.com/item/custom-emails-for-woocommerce/?utm_source=wporg&utm_medium=organic&utm_campaign=readme)

> “Najlepsza wtyczka do wysyłania niestandardowych wiadomości email.” – ⭐⭐⭐⭐⭐ [Mariusz](https://wpfactory.com/item/custom-emails-for-woocommerce/?utm_source=wporg&utm_medium=organic&utm_campaign=readme)
...
= 3.7.4 - 18/08/2026 =
* Dev - WPFactory Key Manager - Library updated (to v1.1.0).
...
= 3.7.0 - 25/03/2026 =
* Dev - Improved release mechanism.
